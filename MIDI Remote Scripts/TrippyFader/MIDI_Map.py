...
# General
PLAY = 0x5E   # Global play
STOP = 0x5D   # Global stop
REC = 0x5F    # Global record
TAPTEMPO = -1   # Tap tempo
NUDGEUP = -1    # Tempo Nudge Up
NUDGEDOWN = -1  # Tempo Nudge Down
UNDO = 0x4C   # Undo
REDO = 0x4B   # Redo
LOOP = 0x56   # Loop on/off
PUNCHIN = -1    # Punch in
...
CLIPTRACKVIEW = 0x57  # Clip/Track view switch
...
SESSIONLEFT = 0x2E  # Session left
SESSIONRIGHT = 0x2F  # Session right
...
# Track Navigation
TRACKLEFT = 0x62   # Track left
TRACKRIGHT = 0x63  # Track right
