...
class TrippyFader(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for TrippyFader in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in TrippyFader._active_instances:   # Make sure you update the name
    ...
    def handle_track_change(self):
        ...
        self._send_midi((99, 99, index,))
        self.log_message('message should be sent')
    ...
    def _do_combine(self):
        if self not in TrippyFader._active_instances:    # Make sure you update the name
            TrippyFader._active_instances.append(self)   # Make sure you update the name
            TrippyFader._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in TrippyFader._active_instances) and TrippyFader._active_instances.remove(self):    # Make sure you update the name
